...
def add_menu(window):
    ...
    about_menu.add_command(label="Meghana S",
                           command=lambda: web.open("https://www.linkedin.com/in/meghana-s-2a9575213/"))
...
window = Tk()
window.title("Transactions Management System")
add_menu(window)
frame = dashboard.get_frame(window)
frame.pack(side=TOP)
